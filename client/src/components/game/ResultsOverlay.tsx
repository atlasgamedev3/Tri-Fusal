    ...
    >
      ...
      >
        ...
        <div className="relative z-[1]">
          ...
          <div className="overflow-hidden rounded-none border border-solid ring-1 ring-inset ring-white/[0.04]" style={{ borderColor: HUD_CHROME.border, background: "rgba(255,255,255,0.03)" }}>
